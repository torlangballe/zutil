...
func (c Color) Hex() string {
	str := c.HexNoAlpha()
	return str + fmt.Sprintf("%02x", int(c.Colors.A*255))
}

func (c Color) HexNoAlpha() string {
	return fmt.Sprintf("#%02x%02x%02x", int(c.Colors.R*255), int(c.Colors.G*255), int(c.Colors.B*255))
}
...
var ColorDistinctList = []Color{ColorOrange, ColorCyan, ColorMagenta, ColorRed, ColorYellow, ColorOlive, ColorLime, ColorGreen, ColorDarkGreen, ColorAqua, ColorTeal, ColorBlue, ColorNavy, ColorDarkGray, ColorFuchsia, ColorPurple}
